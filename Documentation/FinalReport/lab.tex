...
\newcommand{\coversheet}[4]{
  \begin{titlepage}
    ...
    \begin{center}
      ...
      \today \\
      \vspace{.375in}
      This project has developd a prototype “Smart Refrigerator” system, which monitors grocery items purchased by the user in order to reduce food waste and facilitate efficient shopping habits. 
