...
public class ShoppingList implements Serializable
{
	 ...
	 * @param autoGen Whether the {@code ShoppingList} was auto generated
	 */
	 ...
	 * @param item The {@code InventoryItem} to remove
	...
	public int removeItem(InventoryItem item, int quantity)
	{
		...
		for (ShoppingListItem i : items)
		{
			if (i.getUPC() == item.getUPC())
			{
				...
				{
					// if quantity to remove is less than quantity present in list,
					// we replace the ShoppingListItem with one that reflects the 
					// new quantity.
					remaining = quantity - i.getQuantity();
					i = new ShoppingListItem
					(
						i.getUPC(), i.getName(), remaining
					);
				}
			}
