...
public class TestConnect implements DataConnect {
	...
	InventoryItem milk 		= new InventoryItem("1% Milk", 10, new Date("10/11/12"), new Date ("10/01/12"));
	InventoryItem bread 	= new InventoryItem("Wheat Bread", 11, new Date("10/12/12"), new Date ("10/02/12"));
	InventoryItem lemons 	= new InventoryItem("Lemons", 12, new Date("10/13/12"), new Date ("10/03/12"));
	InventoryItem limes 	= new InventoryItem("Limes", 13, new Date("10/14/12"), new Date ("10/04/12"));
	InventoryItem steak 	= new InventoryItem("T-Bone Steak", 14, new Date("10/15/12"), new Date ("10/05/12"));
	InventoryItem cheese 	= new InventoryItem("Cheddar Cheese", 15, new Date("10/16/12"), new Date ("10/06/12"));
	InventoryItem pasta 	= new InventoryItem("Spaghetti", 16, new Date("10/17/12"), new Date ("10/07/12"));
	InventoryItem sauce 	= new InventoryItem("Pasta Sauce", 17, new Date("10/18/12"), new Date ("10/08/12"));
	InventoryItem crackers 	= new InventoryItem("Ritz Crackers", 18, new Date("10/19/12"), new Date ("10/09/12"));
	InventoryItem cereal 	= new InventoryItem("Cereal", 19, new Date("10/20/12"), new Date ("10/10/12"));
	InventoryItem juice 	= new InventoryItem("Orange Juice", 20, new Date("10/21/12"), new Date("10/11/12"));
