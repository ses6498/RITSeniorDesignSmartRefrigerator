 ...
 * 
 * <p>
 * <b>NOTE:</b> This does <i>not</i> extend the {@link OrmLiteBaseActivity} but
 * instead manages the helper itself locally using the {@link #databaseHelper}
 * field, the {@link #getHelper()} private method, and the call to
 * {@link OpenHelperManager#releaseHelper()} inside of the {@link #onDestroy()}
 * method.
 * </p>
 */
public class HelloNoBase extends Activity
{
	...
	private void doSampleDatabaseStuff(String action, TextView tv)
	{
		...
		{
			// get our dao
			Dao<ShoppingList, Integer> simpleDao = getHelper()
					.getShoppingListDao();
			// query for all of the data objects in the database
			List<ShoppingList> list = simpleDao.queryForAll();
